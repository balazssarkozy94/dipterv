...
Egy külön fülön a modul állapotát is nyomonkövethetjük, valamint kiolvashatjuk a C-CAN-en bekövetkezett hibákat, a kiegészítõ modul slave processzorának utolsó resetelésének okát.
...
\begin{figure}[!ht]
\centering
\includegraphics[width=150mm, keepaspectratio]{figures/5_4_1_omicron_harmonics.png}
\caption{OMICRON Harmonics felhasználói felülete}
\end{figure}
...
CHANNEL_ERR_e calibrateHandler(uint16_t channel, uint8_t* data, uint16_t length)
{
    switch(channel)
    {
        ...
        case 302: //312E
        {
            // BEFORE ENTERING THIS SUPPLY 230V, 8A, cosPhi= 0.5 inductive
        ...
        case 303: //312F
        {
            ...
            calibrateMeteringIC_WattOSCalib();
            calibrateMeteringIC_VAROSCalib();
            break;
        }
        case 304: //3130
        {
...
\begin{figure}[!ht]
\centering
\includegraphics[width=150mm, keepaspectratio]{figures/5_4_2_kalibracio_1.PNG}
\caption{Végmérõ és kalibráló szoftver fõmenüje}
\label{crtu_calib_main}
\end{figure}

Egy-egy új modul komponenseinek implementálása egyszerû, a már meglévõ részegységek újrafelhasználhatók, mint például a LED-ek, nyomógombok, kapcsolók teszteji.

A modulhoz tartozó almenüben a végmérés és kalibráció lépéseit egymás után hajthatjuk végre, illetve rögzíthetjük a különbözõ készülék paramétereket, mérési adatokat. A modul specifikus almenünek a felépítése a \ref{crtu_calib_crpm} ábrán láhtható.

\begin{figure}[!ht]
\centering
\includegraphics[width=150mm, keepaspectratio]{figures/5_4_3_kalibracio_2.PNG}
